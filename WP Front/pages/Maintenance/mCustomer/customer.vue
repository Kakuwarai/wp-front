        ...
        <div class="flex items-center">
          ...
          <li aria-current="page">
              <div class="flex items-center">
                  ...
                  <span class="ml-1 text-sm font-medium  md:ml-2 text-gray-400">Customer</span>
              </div>
          </li>
      </ol>
  </nav>
          ...
          <div class="mt-1 relative overflow-x-auto shadow-md sm:rounded-lg">
              <table class="w-full text-sm text-left text-gray-500 ">
                  ...
                  <tbody v-if="tblLoading == false">
                      <tr v-for="data in customerList" class="bg-white border-b  hover:bg-gray-50 ">
                          <td class="px-6 py-4">
                              {{ data.code }}
                          </td>
                          <td class="px-6 py-4">
              ...
              <el-empty v-if="customerList == '' && tblLoading == false" :image-size="200" />
          </div>
          <br>
...
async function getUsers(page) {
  ...
  await globalAPI().post(`mCustomer/customerList?page=${page}&size=${pageSize.value}&search=${txtSearch.value}`)
      .then(async (response) => {
...
function addUser() {
  router.replace('/maintenance/mCustomer/addCustomer')
}

function editUser(editSelectedCustomer) {

  sessionStorage.setItem('editCustomer', JSON.stringify(editSelectedCustomer))
  router.replace('/maintenance/mCustomer/editCustomer')
}
